...
@NamedQueries({
        ...
        @NamedQuery(name = Airport.FIND_BY_COUNTRY_NAME, query = "SELECT a FROM Airport a WHERE a.country.name = :country ORDER BY a.name"),
        @NamedQuery(name = Airport.FIND_BY_COUNTRY_ISO2, query = "SELECT a FROM Airport a WHERE a.country.ISO2 = :country ORDER BY a.name")
})
